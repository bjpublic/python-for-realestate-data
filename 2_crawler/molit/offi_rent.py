...
directory = "0_data/molit/offi_rent"
if not os.path.exists(directory):
    os.makedirs(directory)
    

legal_info = pd.read_csv("0_data/legal_info_b.csv")
...
total = pd.DataFrame()
print("for 시작")
# for year_month_key in year_month_list:
for i in range(len(LAWD_CD_list)):
    ...
    for k in range(len(items)):
        ...
        file_name = '0_data/molit/offi_rent/offi_rent_' + str(year_month_key) + ".csv"
